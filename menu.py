        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    item_list = menu_items[int(menu_category)]
                    item_name = item_list["Item name"]
                    # Ask the customer for the quantity of the menu item
                    item_quantity = input(f"How many {item_name} would you like? (Invalid input will default to 1) ")
...
total = sum(float(item['Price']) * item['Quantity'] for item in order)
print(f"Total: {total}")